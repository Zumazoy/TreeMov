...
class RegTeacher2Screen extends StatefulWidget {
  const RegTeacher2Screen({super.key});

  @override
  State<RegTeacher2Screen> createState() => _RegTeacher2ScreenState();
}

class _RegTeacher2ScreenState extends State<RegTeacher2Screen> {
