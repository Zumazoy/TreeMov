...
class RegKid1Screen extends StatefulWidget {
  const RegKid1Screen({super.key});

  @override
  State<RegKid1Screen> createState() => _RegKid1ScreenState();
}

class _RegKid1ScreenState extends State<RegKid1Screen> {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (_passwordError == null) {
                            Navigator.pushNamed(context, AppRoutes.regKid2);
                          }
                        },
