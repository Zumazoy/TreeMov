            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                      icon: const Icon(Icons.chevron_left, color: AppColors.white, size: 24),
                      onPressed: () {
                        setState(() {
                    ...
                    IconButton(
                      icon: const Icon(Icons.chevron_right, color: AppColors.white, size: 24),
                      onPressed: () {
                        setState(() {
                          _currentDate = DateTime(_currentDate.year, _currentDate.month + 1);
                        });
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected 
                      ...
                      : (isToday ? AppColors.todayBackground : Colors.transparent),
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: isSelected || isToday ? AppColors.white : Colors.black,
                      fontFamily: 'TT Norms',
                    ),
                  ),
                ),
